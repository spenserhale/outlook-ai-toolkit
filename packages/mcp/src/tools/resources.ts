...
function getClient(): OutlookClient {
...
export function registerResourceTools(server: FastMCP) {
  server.addTool({
    name: "list_resources",
    description: "List Outlook resources with pagination",
    parameters: z.object({
  ...
  server.addTool({
    name: "get_resource",
    description: "Get a Outlook resource by its ID",
    parameters: z.object({
  ...
  server.addTool({
    ...
    description: "Create a new Outlook resource",
    parameters: z.object({
  ...
  server.addTool({
    ...
    description: "Delete a Outlook resource by its ID",
    parameters: z.object({
